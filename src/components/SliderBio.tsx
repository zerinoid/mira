...
const SliderBio: FC<Props> = ({ userId, isOpen, setIsOpen }) => {
  ...
  return (
    <aside
      className={`${
        isOpen ? "block" : "hidden"
      } montserrat absolute top-0 left-0 text-background min-h-screen grid grid-cols-[5px_5fr_35fr_13fr] md:grid-cols-[5px_5fr_28fr_20fr] lg:grid-cols-[5px_3fr_20fr_43fr] bg-gradient-to-r from-foreground to-transparent to-30% w-full`}
    >
